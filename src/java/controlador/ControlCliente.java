    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btn_agregar") != null) {
            ...
            try {
                ...
                out1.println("<script src=jquery-latest.js></script><script src=Ajax1.js></script> ");
                ...
                out1.println("</button><button class='button is-danger is-outlined is-small'> <img src='img/basurero.png' /></a></button></td>");
