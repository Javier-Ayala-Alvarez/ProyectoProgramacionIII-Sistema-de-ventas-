...
public class ControladorProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out1.println("<table><tr ><td><td><td><td><td><td><td><td><td><td><td><td><td align='center' class='column is-one-third'>Factura<td>");
        ...
        out1.println("Codigó:</td><td><input type='text'  name='codigopro' id='codigopro' class='input is-success codigopro' value=" + registroproduc.getCodigoProducto() + " readonly/></td><td>");
        ...
        out1.println(" <td>");
        out1.println("<button class='button is-success is-active'><a href='javascript:abrirProducto()' id='btn_Producto'><font color='#fff'>Buscar</a></button></td>");
        out1.println("<td class='column is-one-third'>");
        out1.println(" Cantidad: </td><td> <input type='number' id='cantidad1'  name='cantidad1' value=" + Integer.parseInt(request.getParameter("cantidad")) + " class='input is-success cantidad'/></td><td align='center'>Unds</td>");
        out1.println("<td align='center'>");
        out1.println("Precio Unitario: $</td><td> <input type='text'  name='precioUni' id='precioUni1' placeholder='Precio Unitario' class='input is-success' value=" + String.format("%.2f", registroproduc.getPrecioVenta()) + "  readonly/></td>");
        out1.println("<td align='center'>");
        out1.println("Precio Total: $</td><td><input type='text'  name='precioTotal' id='preciototal1' placeholder='Precio Total' value=" + String.format("%.2f", total) + " class='input is-success' readonly /></td>");
        out1.println("<td align='center'>");
