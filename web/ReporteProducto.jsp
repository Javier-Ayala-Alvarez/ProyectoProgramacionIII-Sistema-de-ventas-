...
<html>
    ...
    <body>
        <h1>  <%  Conexion conexion = new Conexion();
            ...
            File reporfile = new File(application.getRealPath("reporte/ReporteProducto.jasper"));
            Map parameter = new HashMap();

            byte[] bytes = JasperRunManager.runReportToPdf(reporfile.getPath(),null, conexion.getConexion());
