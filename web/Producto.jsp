            ...
            <table  class="TABLE3">
                <tr>
                        ...
                        <form action="ControlProductoAdministracion" method="post">
                            <div class="column">
                                Codigó</td><td><input type='text'  name='codigo'  class='input is-link' value="<%=(dato == null) ? request.getAttribute("codigo") : dato.getCodigoProducto()%>" readonly/></td>
                                <td>Precio Compra</td> <td><input type='text'  name='precioCompra' value="<%=(dato == null) ? "" : dato.getPrecioCompra()%>" class='input is-link' pattern="[0-9\.]*"/></td>
